...
const ModalUser = ({ handleModal, addUser, users, editUserID, editUser }) => {
    ...
    let title =
        editUserID === null ? 'Добавьте участника' : 'Редактирование участника';
    let btnText = editUserID === null ? 'Добавить' : 'Сохранить';

    return (
        <Modal title={title} onClickOutside={handleModal} onClose={handleModal}>
            <form className="form" onSubmit={submitForm}>
                <div className="form-group">
                    ...
                    <input
                        ...
                        className={classNames('form-input', {
                            'form-input--error': isShowNameError,
                        })}
                    />
                    {isShowNameError && (
                        <div className="form-error">Введите имя</div>
                    )}
                </div>
                <div className="form-group">
                    <label htmlFor="user_name" className="form-label">
                ...
                <div className="form-group">
                    <label htmlFor="user_pay" className="form-label">
                        Траты:
                    </label>
                    <div className="form-input-wrap form-input-wrap--rub">
                        <input
                            ...
                            onChange={changePay}
                            className={classNames('form-input', {
                                'form-input--error': isShowPayError,
                            })}
                        />
                ...
                <div className="form-group">
                    <label htmlFor="user_desc" className="form-label">
                        Описание:
                    </label>
